...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        'flex w-fit items-center justify-between gap-2 rounded-xl border border-input bg-card/70 px-3.5 text-sm text-foreground shadow-none whitespace-nowrap transition-[border-color,background-color,box-shadow] outline-none',
